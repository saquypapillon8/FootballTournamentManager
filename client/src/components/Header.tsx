          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/">
              <span className="flex items-center cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 1500 1500" className="text-white mr-2">
                ...
                <span className="font-bold text-white text-xl">Tournoi</span>
              </span>
            </Link>
          </div>
